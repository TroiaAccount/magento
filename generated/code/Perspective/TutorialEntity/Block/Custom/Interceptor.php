<?php
namespace Perspective\TutorialEntity\Block\Custom;

/**
 * Interceptor class for @see \Perspective\TutorialEntity\Block\Custom
 */
class Interceptor extends \Perspective\TutorialEntity\Block\Custom implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Framework\Url\EncoderInterface $urlEncoder, \Magento\Framework\Json\EncoderInterface $jsonEncoder, \Magento\Framework\Stdlib\StringUtils $string, \Magento\Catalog\Helper\Product $productHelper, \Magento\Catalog\Model\ProductTypes\ConfigInterface $productTypeConfig, \Magento\Framework\Locale\FormatInterface $localeFormat, \Magento\Customer\Model\Session $customerSession, \Magento\Catalog\Api\ProductRepositoryInterface $productRepository, \Magento\Framework\Pricing\PriceCurrencyInterface $priceCurrency, array $data, \Perspective\TutorialEntity\Helper\Custom $customHelper)
    {
        $this->___init();
        parent::__construct($context, $urlEncoder, $jsonEncoder, $string, $productHelper, $productTypeConfig, $localeFormat, $customerSession, $productRepository, $priceCurrency, $data, $customHelper);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAnyCustomValue');
        return $pluginInfo ? $this->___callPlugins('getAnyCustomValue', func_get_args(), $pluginInfo) : parent::getAnyCustomValue();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isAvaliable');
        return $pluginInfo ? $this->___callPlugins('isAvaliable', func_get_args(), $pluginInfo) : parent::isAvaliable();
    }
