...
return [
    'modules' => [
        ...
        'MD_CloseInPrice' => 0,
        'MD_CustomPayment' => 0,
        'MD_CustomizeCheckout' => 0,
        'MD_MiddleName' => 0,
        'MD_ValidationWholesaleBuyers' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'Perspective_AdminHelloWorld' => 0,
        'Perspective_Adminka' => 0,
        'Perspective_ClothingMaterial' => 0,
        'Perspective_ColorAttribute' => 0,
        'Perspective_Cource' => 0,
        'Perspective_Customers' => 0,
        'Perspective_DbSchemaPatch' => 0,
        'Perspective_DbScripts' => 1,
        'Perspective_DeclarativeSchema' => 0,
        'Perspective_Delivery' => 0,
        'Perspective_EntityRepository' => 0,
        'Perspective_Hello' => 0,
        'Perspective_ImageInfo' => 0,
        'Perspective_Model' => 0,
        'Perspective_Orders' => 0,
        'Perspective_PaymentMethods' => 0,
        'Perspective_Product' => 0,
